...
%  last modified 24 May 2013 by Jim Ramsay
...
if ~isempty(basismat)
    ...
    switch type
        ...
        case 'sine'
            period   = params(1);
            basismat = sine(evalarg, nbasis, period, nderiv);
        case 'cosine'
            period   = params(1);
            basismat = cosine(evalarg, nbasis, period, nderiv);
        case 'monom'
         ...
         case 'nspline'
            ...
            norder   = nbasis - length(breaks) + 4;
            basismat = nsplineM(evalarg, breaks, norder, nderiv);
        case 'polyg'
