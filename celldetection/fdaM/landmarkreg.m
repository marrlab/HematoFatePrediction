...
%                 strictly monotone warping function.  If not present or
%                 missiing, registration is done using linear interpolation
%                 of lamdmark times in XIMARKS plotted against 
%                 corresponding target times in X0MARKS.
